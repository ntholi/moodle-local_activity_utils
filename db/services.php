...
$functions = array(
    ...
    'local_activity_utils_create_quiz' => array(
        ...
        'methodname' => 'execute',
        'description' => 'Create a new quiz with comprehensive settings',
        'type' => 'write',
        'ajax' => true,
    ...
    'local_activity_utils_get_quiz' => array(
        ...
        'methodname' => 'execute',
        'description' => 'Get complete quiz details with questions and feedback',
        'type' => 'read',
        'ajax' => true,
    ...
    'local_activity_utils_update_quiz_slot' => array(
        'classname' => 'local_activity_utils\external\quiz\update_quiz_slot',
        'methodname' => 'execute',
        'description' => 'Update quiz slot settings (maxmark, page, requireprevious)',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'local/activity_utils:managequizquestions',
    ),
    'local_activity_utils_add_quiz_feedback' => array(
        'classname' => 'local_activity_utils\external\quiz\add_quiz_feedback',
        'methodname' => 'execute',
        'description' => 'Add overall feedback to a quiz based on grade range',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'local/activity_utils:managequizfeedback',
    ),
    'local_activity_utils_delete_quiz_attempt' => array(
        'classname' => 'local_activity_utils\external\quiz\delete_quiz_attempt',
        'methodname' => 'execute',
        'description' => 'Delete a quiz attempt',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'local/activity_utils:managequizattempts',
    ),

    // Question category functions
    'local_activity_utils_create_question_category' => array(
        'classname' => 'local_activity_utils\external\question\create_question_category',
        'methodname' => 'execute',
    ...
    'local_activity_utils_create_question_multichoice' => array(
        'classname' => 'local_activity_utils\external\question\create_question_multichoice',
        'methodname' => 'execute',
        'description' => 'Create a multiple choice question',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'local/activity_utils:createquestions',
    ),
    'local_activity_utils_create_question_truefalse' => array(
        'classname' => 'local_activity_utils\external\question\create_question_truefalse',
        'methodname' => 'execute',
    ...
    'local_activity_utils_create_question_shortanswer' => array(
        'classname' => 'local_activity_utils\external\question\create_question_shortanswer',
        'methodname' => 'execute',
    ...
    'local_activity_utils_create_question_essay' => array(
        'classname' => 'local_activity_utils\external\question\create_question_essay',
        'methodname' => 'execute',
    ...
    'local_activity_utils_create_question_matching' => array(
        'classname' => 'local_activity_utils\external\question\create_question_matching',
        'methodname' => 'execute',
        'description' => 'Create a matching question',
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'local/activity_utils:createquestions',
    ),
    'local_activity_utils_create_question_numerical' => array(
        'classname' => 'local_activity_utils\external\question\create_question_numerical',
        'methodname' => 'execute',
    ...
    'local_activity_utils_delete_question' => array(
        ...
        'type' => 'write',
        'ajax' => true,
        'capabilities' => 'local/activity_utils:deletequestions',
    ),
    'local_activity_utils_duplicate_question' => array(
        'classname' => 'local_activity_utils\external\question\duplicate_question',
        'methodname' => 'execute',
