...
copy /y "%SCRIPT_DIR%classes\external\quiz\update_quiz_slot.php" "%DEST_PATH%\classes\external\quiz\update_quiz_slot.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy quiz\update_quiz_slot.php
    pause
    exit /b 1
)

copy /y "%SCRIPT_DIR%classes\external\quiz\add_quiz_feedback.php" "%DEST_PATH%\classes\external\quiz\add_quiz_feedback.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy quiz\add_quiz_feedback.php
    pause
    exit /b 1
)

copy /y "%SCRIPT_DIR%classes\external\quiz\delete_quiz_attempt.php" "%DEST_PATH%\classes\external\quiz\delete_quiz_attempt.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy quiz\delete_quiz_attempt.php
    pause
    exit /b 1
)

:: Copy question files
copy /y "%SCRIPT_DIR%classes\external\question\create_question_category.php" "%DEST_PATH%\classes\external\question\create_question_category.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy question\create_question_category.php
    pause
    exit /b 1
)
...
copy /y "%SCRIPT_DIR%classes\external\question\create_question_truefalse.php" "%DEST_PATH%\classes\external\question\create_question_truefalse.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy question\create_question_truefalse.php
    pause
    exit /b 1
)

copy /y "%SCRIPT_DIR%classes\external\question\create_question_shortanswer.php" "%DEST_PATH%\classes\external\question\create_question_shortanswer.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy question\create_question_shortanswer.php
    pause
    exit /b 1
)

copy /y "%SCRIPT_DIR%classes\external\question\create_question_essay.php" "%DEST_PATH%\classes\external\question\create_question_essay.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy question\create_question_essay.php
    pause
    exit /b 1
)

copy /y "%SCRIPT_DIR%classes\external\question\create_question_matching.php" "%DEST_PATH%\classes\external\question\create_question_matching.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy question\create_question_matching.php
    pause
    exit /b 1
)

copy /y "%SCRIPT_DIR%classes\external\question\create_question_numerical.php" "%DEST_PATH%\classes\external\question\create_question_numerical.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy question\create_question_numerical.php
    pause
    exit /b 1
)
...
copy /y "%SCRIPT_DIR%classes\external\question\duplicate_question.php" "%DEST_PATH%\classes\external\question\duplicate_question.php" >nul
if errorlevel 1 (
    echo [ERROR] Failed to copy question\duplicate_question.php
    pause
    exit /b 1
)
